...
import com.example.pizza.Activity.SplashScreen;
                                        ...
                                        myRootRef.child("Admin").child(currentUserId).addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                if (dataSnapshot.exists()) {
                                                    ...
                                                    Toast.makeText(AdminLoginActivity.this, "Амжилттай", Toast.LENGTH_SHORT).show();
                                                    startActivity(intent);
                                                    finish();
                                                } else {
                                                    mAuth.signOut();
                                                    Toast.makeText(AdminLoginActivity.this, "Амжилтгүй", Toast.LENGTH_SHORT).show();
