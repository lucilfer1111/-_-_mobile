package com.example.pizza.Admin;
...
public class ReportsActivity extends AppCompatActivity {
    ...
    private void getEntries() {
        ...
        if(reportArrayList.size()>0){
            ...
            totalSell.setText("Нийт борлуулалт: "+totalPrice+"Төгрөг");

            pieEntries.add(new PieEntry(Alacarte, "Pizza", 0));
            pieEntries.add(new PieEntry(Bento, "Drinks", 1));
            pieEntries.add(new PieEntry(Handroll, "Chicken", 2));
            pieEntries.add(new PieEntry(Beverage, "Others", 3));
