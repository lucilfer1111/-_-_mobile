...
import static com.example.pizza.Model.Utils.TAG_medicine_list;
...
import com.example.pizza.Adapter.CartCustomAdapter;
import com.example.pizza.Model.Order;
import com.example.pizza.Model.Product;
import com.example.pizza.Model.Report;
...
public class CheckOutActivity extends AppCompatActivity {
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (order.getTotalPrice() > 0) {
                            ...
                            Toast.makeText(CheckOutActivity.this, "Сагсанд бүтээгдэхүүн байхгүй байна", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void updateSellReport(double totalPrice) {
        ...
        root.child(dateFormat.format(date)).child(key).setValue(report).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                pd.dismiss();
                Toast.makeText(CheckOutActivity.this, "Захиалга илгээгдлээ", Toast.LENGTH_LONG).show();
    ...
    private void initAll() {
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (movement.equals("Delivery")) {
                    ...
                    totalPayablePrice.setText(new DecimalFormat("##.##").format(order.getTotalPrice() + 5000)+"Төгрөг");
                    addressCardView.setVisibility(View.VISIBLE);
                } else {
                    deliveryChargesLayout.setVisibility(View.GONE);
                    totalPayablePrice.setText(new DecimalFormat("##.##").format(order.getTotalPrice())+"Төгрөг");
        ...
        orderPrice.setText(new DecimalFormat("##.##").format(order.getTotalPrice())+"Төгрөг");
        // totalPayablePrice.setText("Rs."+ (order.getTotalPrice()+200));
        totalPayablePrice.setText(new DecimalFormat("##.##").format(order.getTotalPrice() + 10)+"Төгрөг");
