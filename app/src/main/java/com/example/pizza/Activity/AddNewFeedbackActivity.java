    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (text.isEmpty()) {
                    Toast.makeText(AddNewFeedbackActivity.this, "Санал хүсэлтээ оруулна уу", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    root.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(key).setValue(feedback).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Toast.makeText(AddNewFeedbackActivity.this, "Санал хүсэлт илгээлээ", Toast.LENGTH_LONG).show();
                            finish();
                        }
